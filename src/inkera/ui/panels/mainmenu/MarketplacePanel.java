...
public class MarketplacePanel extends JPanel {
	...
	public MarketplacePanel(MainMenuFrame parentFrame, Languages langManager) { // MainMenuFrame parametresi artık isteğe bağlı, kaldırabilirsiniz eğer kullanılmıyorsa
		...
		updateTexts(); // İlk metni ayarla
	}

	public void updateTexts() {
		if (comingSoonLabel != null && languageManager != null) {
			comingSoonLabel.setText(languageManager.getString(Languages.KEY_MARKETPLACE_COMING_SOON));
		}
	}
}