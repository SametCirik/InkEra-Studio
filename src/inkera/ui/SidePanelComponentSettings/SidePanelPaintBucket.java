...
public class SidePanelPaintBucket extends JPanel {
 ...
 // SidePanelBrush sınıf alanlarına ekleyin
	...
	*/
    ...
    private JPanel createBrushPreviewPanel() {
        ...
        JLabel previewLabel = new JLabel("SEÇİLİ FIRÇA ÖN İZLEMESİ BURADA", SwingConstants.CENTER);
